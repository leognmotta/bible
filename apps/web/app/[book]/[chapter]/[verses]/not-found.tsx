        ...
        <div className="space-y-6 text-center">
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">
              O versículo ou intervalo de versículos que você está procurando
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <ul className="text-muted-foreground space-y-1 text-sm">
                    <li>
                      • Versículo único: <code>/gn/1/5</code>
                    </li>
                    <li>
                      • Intervalo: <code>/gn/1/5-10</code>
                    </li>
                    <li>• Verifique se os versículos existem no capítulo</li>
                  </ul>
                </div>
              </div>
            </CardContent>
